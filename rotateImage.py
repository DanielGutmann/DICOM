...
class rotateImage(object):
    ...
    def apply_for_keypoint(self, keypoint):
        ...
        if (area_begin < 0 or area_end_y < 0) or ((area_begin_z < 0 or area_end > self.image3D.Image3D.shape[0]) or
                                                      (area_end_y > self.image3D.Image3D.shape[1] or area_end_z > self.image3D.Image3D.shape[2])):
